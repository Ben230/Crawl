...
describe('PubListView', function() {
  it('pass empty array and hide button returns empty div', function() {
    const pubList = shallow(<PubListView pubs={[]} buttonIsHidden={true}/>);

    expect(pubList.contains(<div></div>)).toBe(true);
  });

  // it('pass empty array and show button returns crawl button', function() {
  //   const pubList = shallow(<PubListView pubs={[]} buttonIsHidden={false}/>);
  //   console.log('publist',pubList)
  //   expect(pubList).toEqual(
  //   <div>
  //   <button>
  //       Calculate Crawl!
  //   </button>
  ...
  it('pass in 1 pub and returns pub details', function() {
    ...
    expect(pubList.find('h3').text()).toEqual("The Ten Bells Spitalfields")
  })
  ...
  //   const pubList = shallow(<PubListView pubs={testPubArr}/>);
  //
  //   expect(pubList.find('ul').text()).toContain("The Ten Bells SpitalfieldsThe Culpeper")
  // })
});
